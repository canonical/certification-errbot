...
from ..models.start_charm_test_execution_request_execution_stage import StartCharmTestExecutionRequestExecutionStage
from ..models.start_charm_test_execution_request_family import StartCharmTestExecutionRequestFamily
...
class StartCharmTestExecutionRequest:
    ...
    Attributes:
        ...
        environment (str):
        test_plan (str):
        family (StartCharmTestExecutionRequestFamily):
        revision (int):
        track (str):
        execution_stage (StartCharmTestExecutionRequestExecutionStage):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        family = StartCharmTestExecutionRequestFamily(d.pop("family"))

        revision = d.pop("revision")

        track = d.pop("track")

        execution_stage = StartCharmTestExecutionRequestExecutionStage(d.pop("execution_stage"))
