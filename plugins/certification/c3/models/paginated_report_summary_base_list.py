...
if TYPE_CHECKING:
    from ..models.report_summary_base import ReportSummaryBase


T = TypeVar("T", bound="PaginatedReportSummaryBaseList")


@_attrs_define
class PaginatedReportSummaryBaseList:
    """
    Attributes:
        ...
        results (Union[Unset, list['ReportSummaryBase']]):
    """

    count: Union[Unset, int] = UNSET
    next_: Union[None, Unset, str] = UNSET
    previous: Union[None, Unset, str] = UNSET
    results: Union[Unset, list["ReportSummaryBase"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for results_item_data in _results or []:
            results_item = ReportSummaryBase.from_dict(results_item_data)

            results.append(results_item)

        paginated_report_summary_base_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
        ...
        paginated_report_summary_base_list.additional_properties = d
        return paginated_report_summary_base_list
