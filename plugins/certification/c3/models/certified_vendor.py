...
T = TypeVar("T", bound="CertifiedVendor")


@_attrs_define
class CertifiedVendor:
    """Serializer for the Certified Vendor objects

    Certified Vendors are vendors with at least one certified configuration.
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        certified_vendor.additional_properties = d
