...
T = TypeVar("T", bound="WritePhysicalMachine")


@_attrs_define
class WritePhysicalMachine:
    ...
    def to_multipart(self) -> dict[str, Any]:
        ...
        canonical_id: tuple[None, bytes, str]

        if isinstance(self.canonical_id, str):
            canonical_id = (None, str(self.canonical_id).encode(), "text/plain")
        else:
            canonical_id = (None, str(self.canonical_id).encode(), "text/plain")

        configuration = (None, str(self.configuration).encode(), "text/plain")

        platform = (None, str(self.platform).encode(), "text/plain")

        secure_id = (None, str(self.secure_id).encode(), "text/plain")
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        write_physical_machine.additional_properties = d
        return write_physical_machine
