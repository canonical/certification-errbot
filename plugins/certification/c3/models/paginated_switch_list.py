...
T = TypeVar("T", bound="PaginatedSwitchList")


@_attrs_define
class PaginatedSwitchList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for results_item_data in _results or []:
            results_item = Switch.from_dict(results_item_data)

            results.append(results_item)

        paginated_switch_list = cls(
            count=count,
            next_=next_,
            previous=previous,
            results=results,
        ...
        paginated_switch_list.additional_properties = d
        return paginated_switch_list
