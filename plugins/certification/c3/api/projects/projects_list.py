...
) -> Optional[list["ReadProject"]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for componentsschemas_paginated_read_project_list_item_data in _response_200:
            componentsschemas_paginated_read_project_list_item = ReadProject.from_dict(
                componentsschemas_paginated_read_project_list_item_data
            )

            response_200.append(componentsschemas_paginated_read_project_list_item)
