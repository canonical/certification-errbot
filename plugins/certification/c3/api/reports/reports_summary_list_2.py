...
from ...models.paginated_report_summary_base_list import PaginatedReportSummaryBaseList
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v2/reports/summary/{reportid}/".format(
            reportid=reportid,
        ),
        "params": params,
    }
...
) -> Optional[PaginatedReportSummaryBaseList]:
    if response.status_code == 200:
        response_200 = PaginatedReportSummaryBaseList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedReportSummaryBaseList]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """API endpoint to get a particular machine report object
