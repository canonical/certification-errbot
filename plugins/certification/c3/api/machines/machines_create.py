...
def _get_kwargs(
    *,
    ...
    if isinstance(body, WritePhysicalMachine):
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = WritePhysicalMachine.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    """View to list and create PhysicalMachines.
    ...
    Args:
        ...
        body (WritePhysicalMachine): Serializer for writing PhysicalMachine objects.
