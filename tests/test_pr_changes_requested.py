...
class TestPRChangesRequested(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.pr_cache = PullRequestCache(repo_filter=["test-repo"])
        self.pr_cache.github_token = "test-token"
        self.pr_cache.github_org = "test-org"
    ...
    def test_get_prs_for_user_returns_changes_requested_category(self):
        ...
        with patch.object(self.pr_cache, 'is_cache_expired') as mock_expired:
            ...
            with patch.object(self.pr_cache, '_get_pr_review_status') as mock_review_status:
